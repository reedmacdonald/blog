...
class App extends Component{
  ...
  <div id='parent'>
    ...
    <div id='div6' className='article'><h5>Architecture</h5><h1 className='titles'>The Brand New NASA Office</h1><button className='topRight' id='blackButton'><b>Read for $0.19</b></button><img className='artImg' id='cornerOne' src={CornerOne}></img></div>
    <div id='div7' className='article'><h5>Travel</h5><h1 className='titles'>Experience the Saharan Sands</h1><button className='topRight' id='tanButton'><b>Read for $0.29</b></button><img className='artImg' id='hand' src={Hand}></img></div>
